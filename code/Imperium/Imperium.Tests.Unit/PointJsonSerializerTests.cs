...
public class PointJsonSerializerTests
{
    ...
    public void TestMissingId()
    {
        ...
        var point = new Point("dk", DeviceType.Virtual, "k", PointType.Integer) { Id = guid };
        var json = JsonSerializer.Serialize(point);
    ...
    {
        var guid = Guid.NewGuid();
        var point = new Point("dk", DeviceType.Virtual, "abc", PointType.Integer) { Id = guid };
        var json = JsonSerializer.Serialize(point);
    ...
    {
        var point = new Point("dk", DeviceType.Virtual, "k", PointType.TimeOnly) { Id = Guid.Empty };
        var json = JsonSerializer.Serialize(point);
